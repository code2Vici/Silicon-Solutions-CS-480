...
public class BuildingsListAdapter extends ArrayAdapter<Building> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.buildings_list_item_layout,parent,false);
        }

        TextView buildingText = (TextView) convertView.findViewById(R.id.building_list_building_text);
        TextView distanceText = (TextView) convertView.findViewById(R.id.building_list_distance_text);
        TextView buildingNumberText = (TextView) convertView.findViewById(R.id.building_list_building_number_text);
